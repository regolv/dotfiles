...
sudo scutil --set ComputerName "revati"
sudo scutil --set HostName "revati"
sudo scutil --set LocalHostName "revati"
sudo defaults write /Library/Preferences/SystemConfiguration/com.apple.smb.server NetBIOSName -string "revati"
